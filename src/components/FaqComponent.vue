...
<template>
   <section
      class=" relative flex flex-col gap-6 sDT:gap-8 w-full sDT:w-[58.6%] max-w-[400px] sDT:max-w-[600px] bg-neo-white mx-6 sDT:mx-0 p-6 sDT:p-10 text-neo-dark-purple font-work-sans rounded-lg sDT:rounded-2xl shadow-accordion z-10">
